...
public class BookController {
    ...
    public List<BookDto> getBooks(){
        return bookService.getAllBooks().stream().map(bookMapper::toBookDto).collect(Collectors.toList());
    }

    @GetMapping(value = "/api/book/filter")
    public List<BookDto> filterBooks(@RequestParam(required = false, name = "author") String author,
    ...
    public ResponseEntity<BookDto> saveBook(@PathVariable("id") long id,
